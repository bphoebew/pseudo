...
function showResult(){
  if (document.querySelector(".alexei").checked ==true && document.querySelector(".jocelyn").checked == true && document.querySelector(".lily").checked == true){
    container.empty();
    container.append(`<p class = "answer"> Congrats you've found all the catfishers! </p>`);
}else if (document.querySelector(".alexei").checked ==true || document.querySelector(".jocelyn").checked == true || document.querySelector(".lily").checked == true){
    container.empty();
